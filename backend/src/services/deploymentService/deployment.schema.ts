...
const createSiteSchema = z.object({
  ...
  customizedDomainName: z.string().optional(),
...
export {createSitePayloadSchema, createServerPayloadSchema, createServicePayloadSchema}
export {updateSitePayloadSchema, updateServerPayloadSchema, updateServicePayloadSchema}
export {deleteServicePayloadSchema}

export type {CreateStaticSitePayload, CreateServerPayload, CreateServicePayload}
export type {UpdateStaticSitePayload, UpdateServerPayload, UpdateServicePayload}
